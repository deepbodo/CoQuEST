...
Prefix="Generate a Hindi question from the given video and transcript. Transcript: {transcript}."
...
import wandb
wandb.init(project="FVIDEOMAEBARTHINDI1")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="FVIDEOMAEBARTHINDI1",
    eval_strategy="steps",
    eval_steps=100,
    save_strategy="steps",
...
# Start training
trainer.train()
trainer.save_model("FVIDEOMAEBARTHINDI1MODEL")
...
results_df.to_csv("final_evaluation_results_hindi_nopeft.csv", index=False)
